...
st.set_page_config(page_title="🧠 Meme Coin Radar v6.1.1", layout="wide")
st.title("🧠 Meme Coin Radar v6.1.1")
st.markdown("🎯 Expanded coin list • Default 6+ visible • Dropdown selection • Crypto fix")
...
if view_mode == "🐸 Meme Coins":
    st.subheader("🐸 Meme Coin Dashboard")
    ...
    coin_map = CRYPTO_COINS
    coin_type = "crypto"
    group_key = "cryptos"

# Dropdown selection
selected = st.multiselect("✅ Select Coins to Track", options=options, default=default, key=f"{coin_type}_select")
