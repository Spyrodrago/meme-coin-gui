...
st.set_page_config(page_title="🧠 Meme Coin Radar v6.1.6", layout="wide")
st.title("🧠 Meme Coin Radar v6.1.6")
st.markdown("✅ Stable fallback • Full display • Safe AI scoring")
